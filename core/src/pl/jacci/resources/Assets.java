...
public class Assets {
	...
	public static void load (long seed) throws IOException {
		...
		// get backgrounds
		Texture tBack = new Texture(Gdx.files.internal("scene/01_B.png"));
		...
		// get doors
		Texture tDoorHole = new Texture(Gdx.files.internal("scene/01_D_H.png"));
		sDoorHole = new Sprite(tDoorHole);
		
		// get rocks
		Texture tRock01 = new Texture(Gdx.files.internal("scene/01_R.png"));
		...
		// get tears
		Texture tTear = new Texture(Gdx.files.internal("tear/tears.png"));
		sTear = new Sprite(tTear, 4*32, 0, 32, 32);
		
		// get players
		Texture tPlayer = new Texture(Gdx.files.internal("char/isaac.png"));
		...
		// get attack fly
		Texture tAttackFly = new Texture(Gdx.files.internal("monster/010_fly.png"));
		...
		// get red boom fly
		Texture tRedBoomFly = new Texture(Gdx.files.internal("monster/020_redboomfly.png"));
		...
		// get UI hearts
		Texture tUI_Hearts = new Texture(Gdx.files.internal("ui/hearts.png"));
	...
	public static void readRockMap (int map, FileHandle file) {
	...
	public static void readMonsterMap (int map, FileHandle file) {
		String[] lines = file.readString().split("\\r?\\n");
		String[][] tiles = new String[7][13];
